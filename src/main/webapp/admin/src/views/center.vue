  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='感兴趣类型' prop="wenzhangTypes">
                 <el-select v-model="ruleForm.wenzhangTypes" placeholder='请选择感兴趣类型'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.wenzhangTypes)&& 'yonghu'==this.flag){
                             this.$message.error('感兴趣类型不能为空');
                             return
                         }

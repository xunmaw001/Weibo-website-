        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="感兴趣类型" prop="wenzhangTypes">
                        <el-select v-model="ruleForm.wenzhangTypes" :disabled="ro.wenzhangTypes" placeholder="请选择感兴趣类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="感兴趣类型" prop="wenzhangValue">
                        <el-input v-model="ruleForm.wenzhangValue"
                            placeholder="感兴趣类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wenzhangTypes: [
                              { required: true, message: '感兴趣类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
